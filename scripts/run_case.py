    ...
    wrapper_path.write_text(
        "\n".join(
            [
                ...
                "    if {![llength [info commands section]] || [llength [info commands __strut_builtin_section]]} {",
                "        return",
                "    }",
                ...
                "    if {![llength [info commands nDMaterial]] || [llength [info commands __strut_builtin_nDMaterial]]} {",
                "        return",
                "    }",
